...
module datapath(
    ...
    assign eretTakeD = eretD & validD & ~stallD;
    assign takeinterruptD = cp0irqActiveD & validD & ~stallD & ~eretD;
    ...
    assign flushD = (pcsrcD | jumpD | jrD | eretTakeD | takeinterruptD) & ~stallD;
    assign flushE = hazardFlushE | eretTakeD | takeinterruptD;
    ...
    flopenrc #(1)  r3D(clk, rst, ~stallD, flushD, 1'b1, validD);
    ...
    floprc #(32) r9E(clk, rst, flushE, cp0rdataD, cp0rdataE);
    floprc #(5)  r10E(clk, rst, flushE, rdD, cp0addrE);
    ...
    flopr #(32) r5M(clk, rst, cp0rdataE, cp0rdataM);
    flopr #(5)  r6M(clk, rst, cp0addrE, cp0addrM);
    ...
    flopr #(32) r5W(clk, rst, cp0rdataM, cp0rdataW);
